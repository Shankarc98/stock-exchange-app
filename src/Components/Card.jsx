...
function Card(props){
    ...
    return <div className="card-cont">
       ...
       <div className="card-buttons">
        <button onClick={() => props.handleClick(1, props.name, props.price)} className="buy-btn btn main-color">Buy</button>
        <button onClick={() => props.handleClick(2, props.name, props.price)} className="sell-btn btn main-color">Sell</button>
       </div>
    </div>
}
